...
def run(episodes,slipperyflag=True,viewflag=False, training=True):
    ...
    environment = gym.make('FrozenLake-v1', map_name="8x8", is_slippery=slipperyflag, render_mode='human' if viewflag else None)
...
if __name__ == "__main__":
    run(1000,slipperyflag=True,training=False)
